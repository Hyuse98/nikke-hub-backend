...
class LevelUpNikkeBurstSkillCaseTest {

    private val nikkeRepository: NikkeRepository = mock()
    private val levelUpNikkeBurstSkillCase = LevelUpNikkeBurstSkillCase(nikkeRepository)
    ...
    fun `should level up when nikke exist`() {
        ...
        val result = levelUpNikkeBurstSkillCase.execute(id)

        assertThat(result.skillBurst.value).isEqualTo(2)
