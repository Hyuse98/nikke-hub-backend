...
class UpgradeNikkeCoreCaseTest {

    private val nikkeRepository: NikkeRepository = mock()
    private val upgradeNikkeCoreCase = UpgradeNikkeCoreCase(nikkeRepository)
    ...
    fun `should level up when nikke exist`() {
        ...
        val result = upgradeNikkeCoreCase.execute(id)

        assertThat(result.core.value).isEqualTo(1)
